...
- **CI/CD & Artifact Management:** Jenkins, Nexus
- **Monitoring & Observability:** Prometheus, Grafana

### Repository Structure
To make navigation easy, this repository is organized hierarchically. Each module contains specific project folders, and every project includes its own dedicated documentation.
...
Feel free to explore the module folders to see my progression, and read the local project READMEs for deep dives into specific implementations.
